...
This is an AI-powered business dashboard that serves as the central operating system for a fertilizing business. The system acts as the homebase and control center for all customer communication, AI automation, scheduling, estimates, and internal workflows.
...
- The **SMS number (Twilio)** is the primary interface for customers
